...
The default target is the existing July 23 comparison batch::
    ...
    .venv/bin/python -m \
        MUJOCO.scripts.add_directional_force_indirect_to_batch

Inspect the exact three commands without running MuJoCo::

    .venv/bin/python -m \
        MUJOCO.scripts.add_directional_force_indirect_to_batch --dry-run
...
DEFAULT_BATCH_DIR = (
    ...
    / "comparison_main_20260723_214914_681226"
)
