...
try:
    ...
    from bimanual_redundancy.paths import REPO_ROOT as REPOSITORY_ROOT
except ModuleNotFoundError as error:
    # Support direct execution by absolute path from outside the repository.
    if error.name != "bimanual_redundancy":
        raise
...
def discover_files(data_dir):
    ...
    if missing:
        ...
        raise FileNotFoundError(
            ...
            "Generate them with:\n"
            "  .venv/bin/python -m "
            "bimanual_redundancy.experiments.dual_franka_eq8_static_comparison --record-data\n"
