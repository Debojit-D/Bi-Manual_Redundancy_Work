...
Run position-first (option 1, the default)::
    ...
    .venv/bin/python -m bimanual_redundancy.experiments.dual_franka_eq8_static_comparison \
        --sweep-option 1
...
from bimanual_redundancy.experiments.dual_franka_eq8_static_optimization import (
