...
Run from the repository root with the project virtual environment::
    ...
    .venv/bin/python -m bimanual_redundancy.experiments.dual_franka_eq8_6d_pick_place_comparison \\
        --sweep-option 1
...
from bimanual_redundancy.experiments import dual_franka_eq8_optimized_6d_pick_place as experiment
