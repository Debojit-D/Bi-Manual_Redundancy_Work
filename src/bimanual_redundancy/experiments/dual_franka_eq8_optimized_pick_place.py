...
Run from the repository root according to what you want to inspect::
    ...
    python -m bimanual_redundancy.experiments.dual_franka_eq8_optimized_pick_place --position 1
    python -m bimanual_redundancy.experiments.dual_franka_eq8_optimized_pick_place --position 2
    ...
    python -m bimanual_redundancy.experiments.dual_franka_eq8_optimized_pick_place --front-view
    python -m bimanual_redundancy.experiments.dual_franka_eq8_optimized_pick_place --top-view
