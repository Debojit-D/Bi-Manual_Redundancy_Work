...
Run with the default perspective, front, or overhead camera::
    ...
    python -m bimanual_redundancy.experiments.dual_franka_eq8_baseline_pick_place --front-view
    python -m bimanual_redundancy.experiments.dual_franka_eq8_baseline_pick_place --top-view
