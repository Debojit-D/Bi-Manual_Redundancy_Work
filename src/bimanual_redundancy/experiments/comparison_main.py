...
Run from the repository root::
    ...
    .venv/bin/python -m bimanual_redundancy.experiments.comparison_main

Preview the exact three child commands without starting MuJoCo::

    .venv/bin/python -m bimanual_redundancy.experiments.comparison_main --dry-run
...
STAGES = (
    ("static", "bimanual_redundancy.experiments.dual_franka_eq8_static_comparison"),
    (
        "pick_place",
...
DEFAULT_OUTPUT_ROOT = paths.OUTPUT_COMPARISON_BATCHES_DIR
