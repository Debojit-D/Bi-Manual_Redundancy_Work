### This version of the code is working for the moving box. Gains need to be tuned
...
def compute_next_phi(A, J_h, current_index, positions, orientations, q_dot_d, delta_t=0.01, K_p=1):
