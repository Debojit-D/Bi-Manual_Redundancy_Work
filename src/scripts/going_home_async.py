...
def main():
    ...
    # Set motion speed parameters
    both_arms_group.set_max_velocity_scaling_factor(0.8)  # Increase velocity scaling
    both_arms_group.set_max_acceleration_scaling_factor(0.8)  # Increase acceleration scaling
    both_arms_group.set_planning_time(2.0)  # Reduce planning time for quicker response
    both_arms_group.set_planner_id("RRTConnectkConfigDefault")  # Use a faster planner
