#### This is for directional force manipulability optimization
...
def compute_phi_dot_opt(A, optimization_type, gain=0.0000000003):
    ...
    if optimization_type == "velocity_manipulability":
        ...
        F = np.array([0, 0, -9.81*3, 0, 0, 0])  # Assuming 6D force vector
...
def directional_force_manipulability(A, F):
    ...
    return np.sqrt(np.trace(first_term))
