...
def open_gripper(gripper_pub):
    ...
    trajectory.joint_names = ["right_arm_finger_joint1", "right_arm_finger_joint2"]  # Both fingers
...
def main():
    ...
    # Initialize MoveIt commander for the right arm
    arm_group = moveit_commander.MoveGroupCommander("right_arm")

    # Publisher for gripper command
    gripper_pub = rospy.Publisher(
        "/right_hand_controller/command", JointTrajectory, queue_size=10
    )
    ...
    roll, pitch, yaw = -1.54, 0.7855, 0.0
