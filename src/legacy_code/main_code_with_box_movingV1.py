...
def compute_next_phi(A, J_h, current_index, positions, orientations, q_dot_d, delta_t=0.01, K_p=0.1):
    global current_joint_states
    ...
    box_position = positions  # Extract the desired position from positions
    box_orientation = orientations  # Extract the desired orientation
    set_box_state(box_position, box_orientation)  # Call the function to move the box
