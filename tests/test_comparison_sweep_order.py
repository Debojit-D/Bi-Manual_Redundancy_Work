...
from bimanual_redundancy.experiments.dual_franka_eq8_6d_pick_place_comparison import (
    EXPERIMENTS,
    experiments_for_mode,
    resolve_trajectory_cases,
    video_views_for_choice,
)
from bimanual_redundancy.experiments.dual_franka_eq8_pick_place_comparison import (
    experiments_for_mode as pick_place_experiments_for_mode,
)
from bimanual_redundancy.experiments.dual_franka_eq8_static_comparison import (
